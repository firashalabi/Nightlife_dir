  ...
  return (
    <>
     <section className="flex justify-center bg-primary-50 bg-dotted-pattern bg-contain">
      <div className="grid grid-cols-1 md:grid-cols-2 2cl:max-w-7">
       <Image
       src={event.imageUrl}
       alt="hero image"
       width={1000}
       ...
       <div className="flex w-full flex-col gap-8 p-5 md:p-10 ">
        <div className="flkex flex-col gap-6">
       ...
       <div className="flex flex-col gap-5">
        <div className="flex gap-2 md:gap-3">
          ...
          height={32}
          />
          <div className='p-medium-16 lg:p-regular-28 flex flex-wrap items-center'>
